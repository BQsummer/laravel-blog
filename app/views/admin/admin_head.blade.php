<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="#"><span class="glyphicon glyphicon-pencil">&nbsp;文章</a></li>
                    <li><a href="#"><span class="glyphicon glyphicon-comment">&nbsp;评论</a></li>
                    <li class="selected"><a href=""><span class="glyphicon glyphicon-cog">&nbsp;设置</a></li>
                    <li><a href="#"><span class="glyphicon glyphicon-film">&nbsp;多媒体管理</a></li>      
                </ul>
